			...
			<Col xs={6}>
				...
				<Row>
					<Col xs={12} className='text-right'>
						<ButtonGroup>
							<Button bsSize='large'
								onClick={props.sync === clock.SyncMode.Arduino ? arduino.Play : clock.Play} bsStyle={props.playing ? 'success' : 'default'}>
								<i className='fa fa-play'></i>
							</Button>
							<Button bsSize='large'
								onClick={props.sync === clock.SyncMode.Arduino ? arduino.Stop : clock.Stop}>
