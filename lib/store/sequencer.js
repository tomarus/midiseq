...
let defaultRow = {
	note: 48, repeat: 1, retrig: false, len: 0, vel: 100, active: false
}
	...
	seq: [
		{
			...
			name: 'default',
			sequence: [
				{ note: 49, repeat: 1, retrig: false, len: 0, vel: 100, active: false },
				{ note: 60, repeat: 2, retrig: true, len: 0, vel: 100, active: false },
				{ note: 48, repeat: 1, retrig: false, len: 0, vel: 100, active: false },
				{ note: 60, repeat: 2, retrig: true, len: 0, vel: 100, active: false },
				{ note: 49, repeat: 1, retrig: false, len: 0, vel: 100, active: false },
				{ note: 60, repeat: 2, retrig: true, len: 0, vel: 100, active: false },
				{ note: 49, repeat: 2, retrig: true, len: 0, vel: 100, active: false },
				{ note: 72, repeat: 1, retrig: false, len: 1, vel: 100, active: false }
			]
		},
		{
			device: 0,
